...
function ScheduleBuilder({
  ...
  const handleEditActivity = (act) => {
    setForm({
      ...
      moodSupport: act.moodSupport || 'happy'
    });
  ...
  const completed =
    sorted.filter(a => a.status === 'Completed').length;

  // RULE-BASED RECOMMENDATION ALGORITHM
  const recommendation =
    getMoodRecommendation(form.moodSupport);
      ...
      <main className="builder-main fade-in">
        ...
        <div className="builder-header">
          <div>
            ...
            <p className="dash-subtitle">
              Build and manage daily activities for your child.
            </p>
        ...
        {!child && (
          <div className="empty-state">
            ...
            <p>
              Choose a child profile above to view or build their schedule.
            </p>
        ...
        {child && (
          <>
            ...
            {/* Recommendation Card */}
            <div className="schedule-summary fade-in">
            ...
            <div className="schedule-summary">
              ...
              <div className="summary-stats">
                ...
                <span className="badge badge-orange">
                  ⏳ {sorted.length - completed} Pending
                </span>
                ...
                >
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group">
                      ...
                      <select
                        value={form.moodSupport}
                        onChange={(e) =>
                          setForm({
                            ...form,
                            moodSupport: e.target.value
                          })
                        }
                      >
            ...
            {sorted.length === 0 ? (
              ...
              >
                ...
                <p>
                  Click "Add Activity" to start building today's schedule.
                </p>
              ...
              <div className="activities-list">
                ...
                {sorted.map((act, i) => (
                  ...
                  >
                    ...
                    <div className="activity-icon-big">
                      {act.icon}
                    </div>
                    ...
                    <div className="activity-btns">
                      ...
                      <button
                        className="icon-action-btn del-btn"
                        onClick={() =>
                          handleDelete(act.id)
                        }
                      >
